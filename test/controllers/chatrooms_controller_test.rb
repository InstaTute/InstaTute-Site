...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { course_id: @chatroom.course_id, finish: @chatroom.finish, start: @chatroom.start, topic: @chatroom.topic, tutor_id: @chatroom.tutor_id, user_id: @chatroom.user_id } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { course_id: @chatroom.course_id, finish: @chatroom.finish, start: @chatroom.start, topic: @chatroom.topic, tutor_id: @chatroom.tutor_id, user_id: @chatroom.user_id } }
